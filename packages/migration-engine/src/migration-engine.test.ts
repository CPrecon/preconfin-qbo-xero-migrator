...
const baseSnapshot: AccountingSnapshot = {
  ...
  accounts: [
    { id: "acct_1", name: "Checking", classification: "bank", active: true, code: "100", source: { sourceSystem: "quickbooks-online", sourceId: "1", sourceType: "account", metadata: {} } },
    { id: "acct_2", name: "Mystery", classification: "other", active: true, source: { sourceSystem: "quickbooks-online", sourceId: "2", sourceType: "account", metadata: {} } }
  ],
  contacts: [], items: [], invoices: [], bills: [], payments: [], credits: [], journals: [], taxRates: [], currencies: [], tracking: [], balances: [],
...
describe("createMigrationPlan", () => {
  it("maps accounts and flags unsupported account types", () => {
    ...
    expect(plan.exceptions.some((exception) => exception.code === "UNSUPPORTED_ACCOUNT_TYPE")).toBe(true);
  });
});
